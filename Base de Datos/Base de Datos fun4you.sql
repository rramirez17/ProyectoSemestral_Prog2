...
-- Volcando datos para la tabla fun4you.amigos: ~0 rows (aproximadamente)
DELETE FROM `amigos`;
...
-- Volcando datos para la tabla fun4you.contacto: ~0 rows (aproximadamente)
DELETE FROM `contacto`;
/*!40000 ALTER TABLE `contacto` DISABLE KEYS */;
INSERT INTO `contacto` (`id_contacto`, `nombre_usuario`, `correo_persona`, `asunto`, `contenido`, `created_at`, `updated_at`, `id_usuario`) VALUES
	(1, 'Jose Saavedra', '13joselon@gmail.com', NULL, 'Me gusta su red social', '2021-07-27 11:46:50', '2021-07-27 11:46:50', 1);
...
INSERT INTO `likes` (`id_meme`, `id_usuario`, `created_at`, `updated_at`) VALUES
	(1, 3, '2021-07-27 11:57:32', '2021-07-27 11:57:32');
...
-- Volcando datos para la tabla fun4you.likesdados: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Todos los usuarios pueden subir memes a fun4u, en esta tabla se almacenan estos memes.';

-- Volcando datos para la tabla fun4you.meme: ~1 rows (aproximadamente)
DELETE FROM `meme`;
...
INSERT INTO `meme` (`id_meme`, `titulo_meme`, `imagen_meme`, `id_usuario`, `created_at`, `updated_at`, `likes`) VALUES
	(1, 'Cristiano penal', 'https://as.com/futbol/imagenes/2021/06/26/album/1624741264_575903_1624860812_album_grande.jpg', 1, '2021-07-27 11:45:21', '2021-07-27 11:57:32', 00000000001),
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='En Fun4U las personas pueden tener varios usuarios pero un usuario puede pertenecer a una sola persona.';

-- Volcando datos para la tabla fun4you.usuario: ~1 rows (aproximadamente)
DELETE FROM `usuario`;
